...
export class ProductsComponent {
  products:Product[]=[
    ...
    },
    {
      ...
      description:"India has largest Diaspora in the world. Indian Diaspora are leaders in many domains. We are proud that they are making this world a better place to live...",
    ...
    },
    {
      ...
      description:"India has a wide verity of geographic features. There are Mountains to Attols, Plains to Plateaus , Evergreen forests to Alpine Coniferous forests. India is heaven on the Earth...",
